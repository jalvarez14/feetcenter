...
abstract class BaseRecursoPeer
{
    ...
    const IDRECURSO = 'recurso.idrecurso';

    /** the column name for the recurso_nombre field */
    const RECURSO_NOMBRE = 'recurso.recurso_nombre';

    /** the column name for the recurso_descripcion field */
    const RECURSO_DESCRIPCION = 'recurso.recurso_descripcion';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idrecurso', 'RecursoNombre', 'RecursoDescripcion', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idrecurso', 'recursoNombre', 'recursoDescripcion', ),
        BasePeer::TYPE_COLNAME => array (RecursoPeer::IDRECURSO, RecursoPeer::RECURSO_NOMBRE, RecursoPeer::RECURSO_DESCRIPCION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDRECURSO', 'RECURSO_NOMBRE', 'RECURSO_DESCRIPCION', ),
        BasePeer::TYPE_FIELDNAME => array ('idrecurso', 'recurso_nombre', 'recurso_descripcion', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idrecurso' => 0, 'RecursoNombre' => 1, 'RecursoDescripcion' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idrecurso' => 0, 'recursoNombre' => 1, 'recursoDescripcion' => 2, ),
        BasePeer::TYPE_COLNAME => array (RecursoPeer::IDRECURSO => 0, RecursoPeer::RECURSO_NOMBRE => 1, RecursoPeer::RECURSO_DESCRIPCION => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDRECURSO' => 0, 'RECURSO_NOMBRE' => 1, 'RECURSO_DESCRIPCION' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('idrecurso' => 0, 'recurso_nombre' => 1, 'recurso_descripcion' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(RecursoPeer::IDRECURSO);
            $criteria->addSelectColumn(RecursoPeer::RECURSO_NOMBRE);
            $criteria->addSelectColumn(RecursoPeer::RECURSO_DESCRIPCION);
        } else {
            $criteria->addSelectColumn($alias . '.idrecurso');
            $criteria->addSelectColumn($alias . '.recurso_nombre');
            $criteria->addSelectColumn($alias . '.recurso_descripcion');
        }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(RecursoPeer::IDRECURSO) && $criteria->keyContainsValue(RecursoPeer::IDRECURSO) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(RecursoPeer::IDRECURSO);
            $value = $criteria->remove(RecursoPeer::IDRECURSO);
            if ($value) {
                $selectCriteria->add(RecursoPeer::IDRECURSO, $value, $comparison);
            } else {
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += RecursoPeer::doOnDeleteCascade(new Criteria(RecursoPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(RecursoPeer::IDRECURSO, (array) $values, Criteria::IN);
        }
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += RecursoPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = RecursoPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {
            ...
            $criteria->add(RolrecursoPeer::IDRECURSO, $obj->getIdrecurso());
            $affectedRows += RolrecursoPeer::doDelete($criteria, $con);
        }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(RecursoPeer::DATABASE_NAME);
        $criteria->add(RecursoPeer::IDRECURSO, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(RecursoPeer::DATABASE_NAME);
            $criteria->add(RecursoPeer::IDRECURSO, $pks, Criteria::IN);
