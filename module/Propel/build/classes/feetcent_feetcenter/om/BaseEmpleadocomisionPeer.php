...
/**
 * Base static class for performing query and update operations on the 'empleadocomision' table.
 *
 *
 *
 * @package propel.generator.feetcent_feetcenter.om
 */
abstract class BaseEmpleadocomisionPeer
{
    ...
    const TABLE_NAME = 'empleadocomision';

    /** the related Propel class for this table */
    const OM_CLASS = 'Empleadocomision';
    ...
    /**
     * An identity map to hold any loaded instances of Empleadocomision objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array Empleadocomision[]
     */
    ...
    {
        $toNames = EmpleadocomisionPeer::getFieldNames($toType);
        $key = isset(EmpleadocomisionPeer::$fieldKeys[$fromType][$name]) ? EmpleadocomisionPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(EmpleadocomisionPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, EmpleadocomisionPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return EmpleadocomisionPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. EmpleadocomisionPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(EmpleadocomisionPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(EmpleadocomisionPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = EmpleadocomisionPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return EmpleadocomisionPeer::populateObjects(EmpleadocomisionPeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param Empleadocomision $obj A Empleadocomision object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = (string) $obj->getIdempleadocomision();
            } // if key === null
            EmpleadocomisionPeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A Empleadocomision object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Empleadocomision) {
                $key = (string) $value->getIdempleadocomision();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Empleadocomision object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(EmpleadocomisionPeer::$instances[$key]);
        }
     ...
     * @return Empleadocomision Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(EmpleadocomisionPeer::$instances[$key])) {
                return EmpleadocomisionPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (EmpleadocomisionPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        EmpleadocomisionPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to empleadocomision
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = EmpleadocomisionPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = EmpleadocomisionPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                EmpleadocomisionPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (Empleadocomision object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = EmpleadocomisionPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = EmpleadocomisionPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + EmpleadocomisionPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = EmpleadocomisionPeer::OM_CLASS;
            $obj = new $cls();
    ...
    /**
     * Selects a collection of Empleadocomision objects pre-filled with their Empleado objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Empleadocomision objects.
    ...
    public static function doSelectJoinEmpleado(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Empleadocomision) to $obj2 (Empleado)
                $obj2->addEmpleadocomision($obj1);
    ...
    /**
     * Selects a collection of Empleadocomision objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return Propel::getDatabaseMap(EmpleadocomisionPeer::DATABASE_NAME)->getTable(EmpleadocomisionPeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseEmpleadocomisionPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseEmpleadocomisionPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \EmpleadocomisionTableMap());
      }
    }
    ...
    {
        return EmpleadocomisionPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a Empleadocomision or Criteria object.
     *
     * @param      mixed $values Criteria or Empleadocomision object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from Empleadocomision object
        }

        if ($criteria->containsKey(EmpleadocomisionPeer::IDEMPLEADOCOMISION) && $criteria->keyContainsValue(EmpleadocomisionPeer::IDEMPLEADOCOMISION) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a Empleadocomision or Criteria object.
     *
     * @param      mixed $values Criteria or Empleadocomision object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(EmpleadocomisionPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(EmpleadocomisionPeer::IDEMPLEADOCOMISION);
            $value = $criteria->remove(EmpleadocomisionPeer::IDEMPLEADOCOMISION);
            if ($value) {
                $selectCriteria->add(EmpleadocomisionPeer::IDEMPLEADOCOMISION, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(EmpleadocomisionPeer::TABLE_NAME);
            }

        } else { // $values is Empleadocomision object
    ...
    /**
     * Deletes all rows from the empleadocomision table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(EmpleadocomisionPeer::TABLE_NAME, $con, EmpleadocomisionPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            EmpleadocomisionPeer::clearInstancePool();
            EmpleadocomisionPeer::clearRelatedInstancePool();
            $con->commit();
    ...
    /**
     * Performs a DELETE on the database, given a Empleadocomision or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or Empleadocomision object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof Empleadocomision) { // it's a model object
            // invalidate the cache for this single object
            EmpleadocomisionPeer::removeInstanceFromPool($values);
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(EmpleadocomisionPeer::DATABASE_NAME);
            $criteria->add(EmpleadocomisionPeer::IDEMPLEADOCOMISION, (array) $values, Criteria::IN);
            // invalidate the cache for this object(s)
            foreach ((array) $values as $singleval) {
                EmpleadocomisionPeer::removeInstanceFromPool($singleval);
            }
        }
    ...
    /**
     * Validates all modified columns of given Empleadocomision object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param Empleadocomision $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(EmpleadocomisionPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(EmpleadocomisionPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(EmpleadocomisionPeer::DATABASE_NAME, EmpleadocomisionPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = EmpleadocomisionPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(EmpleadocomisionPeer::DATABASE_NAME);
        $criteria->add(EmpleadocomisionPeer::IDEMPLEADOCOMISION, $pk);

        $v = EmpleadocomisionPeer::doSelect($criteria, $con);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(EmpleadocomisionPeer::DATABASE_NAME);
            $criteria->add(EmpleadocomisionPeer::IDEMPLEADOCOMISION, $pks, Criteria::IN);
            $objs = EmpleadocomisionPeer::doSelect($criteria, $con);
        }

        return $objs;
    }

} // BaseEmpleadocomisionPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseEmpleadocomisionPeer::buildTableMap();
