...
/**
 * Base class that represents a row from the 'encargadoclinica' table.
 *
 *
 *
 * @package    propel.generator.feetcent_feetcenter.om
 */
abstract class BaseEncargadoclinica extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'EncargadoclinicaPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        EncargadoclinicaPeer
     */
    ...
    /**
     * The value for the idencargadoclinica field.
     * @var        int
     */
    protected $idencargadoclinica;
    ...
    /**
     * Get the [idencargadoclinica] column value.
     *
     * @return int
     */
    public function getIdencargadoclinica()
    {

        return $this->idencargadoclinica;
    }
    ...
    /**
     * Set the value of [idencargadoclinica] column.
     *
     * @param  int $v new value
     * @return Encargadoclinica The current object (for fluent API support)
     */
    public function setIdencargadoclinica($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idencargadoclinica !== $v) {
            $this->idencargadoclinica = $v;
            $this->modifiedColumns[] = EncargadoclinicaPeer::IDENCARGADOCLINICA;
        }


        return $this;
    } // setIdencargadoclinica()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idencargadoclinica = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = EncargadoclinicaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Encargadoclinica object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EncargadoclinicaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EncargadoclinicaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EncargadoclinicaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = EncargadoclinicaPeer::IDENCARGADOCLINICA;
        if (null !== $this->idencargadoclinica) {
        ...
        if ($this->isColumnModified(EncargadoclinicaPeer::IDENCARGADOCLINICA)) {
            $modifiedColumns[':p' . $index++]  = '`idencargadoclinica`';
        }
        if ($this->isColumnModified(EncargadoclinicaPeer::IDCLINICA)) {
            $modifiedColumns[':p' . $index++]  = '`idclinica`';
        }
        if ($this->isColumnModified(EncargadoclinicaPeer::IDEMPLEADO)) {
            $modifiedColumns[':p' . $index++]  = '`idempleado`';
        }

        $sql = sprintf(
            'INSERT INTO `encargadoclinica` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idencargadoclinica`':
                        $stmt->bindValue($identifier, $this->idencargadoclinica, PDO::PARAM_INT);
                        break;
                    case '`idclinica`':
    ...
    {
        $pos = EncargadoclinicaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdencargadoclinica();
                break;
            case 1:
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Encargadoclinica'][$this->getPrimaryKey()] = true;
        $keys = EncargadoclinicaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdencargadoclinica(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdencargadoclinica($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdencargadoclinica($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EncargadoclinicaPeer::IDENCARGADOCLINICA)) $criteria->add(EncargadoclinicaPeer::IDENCARGADOCLINICA, $this->idencargadoclinica);
        if ($this->isColumnModified(EncargadoclinicaPeer::IDCLINICA)) $criteria->add(EncargadoclinicaPeer::IDCLINICA, $this->idclinica);
        if ($this->isColumnModified(EncargadoclinicaPeer::IDEMPLEADO)) $criteria->add(EncargadoclinicaPeer::IDEMPLEADO, $this->idempleado);
    ...
    {
        $criteria = new Criteria(EncargadoclinicaPeer::DATABASE_NAME);
        $criteria->add(EncargadoclinicaPeer::IDENCARGADOCLINICA, $this->idencargadoclinica);
    ...
    /**
     * Generic method to set the primary key (idencargadoclinica column).
     *
    ...
    {
        $this->setIdencargadoclinica($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdencargadoclinica();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Encargadoclinica (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Encargadoclinica Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EncargadoclinicaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EncargadoclinicaPeer();
        }
    ...
    {
        return (string) $this->exportTo(EncargadoclinicaPeer::DEFAULT_STRING_FORMAT);
    }
