...
abstract class BaseCompradetallePeer
{
    ...
    public static function doSelectJoinProductoclinica(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Compradetalle) to $obj2 (Productoclinica)
                $obj2->addCompradetalle($obj1);
    ...
    /**
     * Selects a collection of Compradetalle objects pre-filled with all related objects except Productoclinica.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
