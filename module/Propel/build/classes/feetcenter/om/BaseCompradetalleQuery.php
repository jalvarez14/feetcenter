...
abstract class BaseCompradetalleQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `idcompradetalle`, `idcompra`, `idproductoclinica`, `compradetalle_cantidad`, `compradetalle_costounitario`, `compradetalle_subtotal` FROM `compradetalle` WHERE `idcompradetalle` = :p0';
        try {
