...
abstract class BasePacienteseguimientoPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idpacienteseguimiento', 'Idpaciente', 'Idcanalcomunicacion', 'PacienteseguimientoFechacreacion', 'PacienteseguimientoComentario', 'PacienteseguimientoFecha', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idpacienteseguimiento', 'idpaciente', 'idcanalcomunicacion', 'pacienteseguimientoFechacreacion', 'pacienteseguimientoComentario', 'pacienteseguimientoFecha', ),
        BasePeer::TYPE_COLNAME => array (PacienteseguimientoPeer::IDPACIENTESEGUIMIENTO, PacienteseguimientoPeer::IDPACIENTE, PacienteseguimientoPeer::IDCANALCOMUNICACION, PacienteseguimientoPeer::PACIENTESEGUIMIENTO_FECHACREACION, PacienteseguimientoPeer::PACIENTESEGUIMIENTO_COMENTARIO, PacienteseguimientoPeer::PACIENTESEGUIMIENTO_FECHA, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPACIENTESEGUIMIENTO', 'IDPACIENTE', 'IDCANALCOMUNICACION', 'PACIENTESEGUIMIENTO_FECHACREACION', 'PACIENTESEGUIMIENTO_COMENTARIO', 'PACIENTESEGUIMIENTO_FECHA', ),
        BasePeer::TYPE_FIELDNAME => array ('idpacienteseguimiento', 'idpaciente', 'idcanalcomunicacion', 'pacienteseguimiento_fechacreacion', 'pacienteseguimiento_comentario', 'pacienteseguimiento_fecha', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idpacienteseguimiento' => 0, 'Idpaciente' => 1, 'Idcanalcomunicacion' => 2, 'PacienteseguimientoFechacreacion' => 3, 'PacienteseguimientoComentario' => 4, 'PacienteseguimientoFecha' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idpacienteseguimiento' => 0, 'idpaciente' => 1, 'idcanalcomunicacion' => 2, 'pacienteseguimientoFechacreacion' => 3, 'pacienteseguimientoComentario' => 4, 'pacienteseguimientoFecha' => 5, ),
        BasePeer::TYPE_COLNAME => array (PacienteseguimientoPeer::IDPACIENTESEGUIMIENTO => 0, PacienteseguimientoPeer::IDPACIENTE => 1, PacienteseguimientoPeer::IDCANALCOMUNICACION => 2, PacienteseguimientoPeer::PACIENTESEGUIMIENTO_FECHACREACION => 3, PacienteseguimientoPeer::PACIENTESEGUIMIENTO_COMENTARIO => 4, PacienteseguimientoPeer::PACIENTESEGUIMIENTO_FECHA => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPACIENTESEGUIMIENTO' => 0, 'IDPACIENTE' => 1, 'IDCANALCOMUNICACION' => 2, 'PACIENTESEGUIMIENTO_FECHACREACION' => 3, 'PACIENTESEGUIMIENTO_COMENTARIO' => 4, 'PACIENTESEGUIMIENTO_FECHA' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('idpacienteseguimiento' => 0, 'idpaciente' => 1, 'idcanalcomunicacion' => 2, 'pacienteseguimiento_fechacreacion' => 3, 'pacienteseguimiento_comentario' => 4, 'pacienteseguimiento_fecha' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Pacienteseguimiento) to the collection in $obj2 (Paciente)
                $obj2->addPacienteseguimiento($obj1);
