...
class comprobanteTransferencia extends FPDF {
    
    public $cancelled;
    public $transferencia;

    public function __construct($transferencia,$cancelled=false) {
    ...
    public function Header() {
        ...
        $this->Cell(70, 4, $this->transferencia->getTransferenciaCreadaen('d/m/Y'), 0, 0, 'L');
        ...
        $this->Ln();
        $this->SetFont('', '',8);
        $this->Cell(95, 4, $this->transferencia->getClinicaRelatedByIdclinicaremitente()->getClinicaNombre(), 0);
        $this->Cell(95, 4, $this->transferencia->getClinicaRelatedByIdclinicadestinataria()->getClinicaNombre(), 0);
        $this->Ln(10);
